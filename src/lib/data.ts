...
export const projects = [
  {
    ...
    title: "AssetDot",
    description:
      "RWA tokenization platform built on Portaldot. Tokenize Lagos real estate, Accra farmland, and any real-world asset — then trade and bridge across chains with ZKP privacy.",
  ...
  },
  {
    ...
    title: "Arc Terminal",
    description:
      "Full-featured DeFi trading terminal. Send USDC, swap EURC, bridge across chains, manage payroll, and run a storefront — all in one place on Arc Testnet.",
    tags: ["Next.js", "Arc SDK", "USDC", "DeFi", "Web3"],
    category: "Web3",
    status: "Live",
    year: "2025",
  ...
  },
  {
    ...
    title: "ORO",
    description:
      "AI-powered execution layer for capital. Set your strategy once — ORO monitors, adapts, and executes 24/7 with 99.6% accuracy, sub-200ms response, and zero emotion.",
  ...
  },
  {
    ...
    title: "OsogboRent",
    description:
      "Osogbo's most trusted property platform. Browse verified listings of houses, shops, and apartments for rent or sale across every neighbourhood in Osogbo, Nigeria.",
  ...
  },
  {
    ...
    title: "ArcBounty",
    description:
      "On-chain developer bounty board powered by Arc SDK. Post tasks, claim work, and get paid in real USDC with sub-second settlement. No middleman, no delays.",
    tags: ["Next.js", "Arc SDK", "USDC", "Supabase", "Web3"],
    category: "Web3",
    status: "Live",
    year: "2025",
